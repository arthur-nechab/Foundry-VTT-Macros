// 16h de repos dans un lieu calme (caverne, camp sécurisé)
// Vous gagnez les mêmes effets qu’un repos nocturne
// Vous regagnez vos compétences de repos long
// Vous pouvez regagnez vos emplacements de sorts de niveau 6 ou plus
(async()=>{
  ...
  new Dialog({content, title : `Repos long`, 
      buttons : {
        Ok : {
          label : `Ok`,
          callback : async (html) => {
